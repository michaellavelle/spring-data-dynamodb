...
public class SimpleDynamoDBCrudRepositoryTest {
	...
	public void deleteById() {
		...
		repoForEntityWithOnlyHashKey.delete(id);
	...
	public void deleteIterable() {
		repoForEntityWithOnlyHashKey.delete(findAllResultMock);
	...
	public void existsEntityWithOnlyHashKey() {
		...
		boolean actual = repoForEntityWithOnlyHashKey.exists(1l);
	...
	public void testBatchSave() {
		...
		entities.add(new User());
		when(dynamoDBOperations.batchSave(anyIterable())).thenReturn(Collections.<FailedBatch>emptyList());

		repoForEntityWithOnlyHashKey.save(entities);
